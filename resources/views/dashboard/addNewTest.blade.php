        ...
        <div class="card-body p-3">
            ...
            <form action="{{ route('add-new-test') }}" method="POST">
                ...
                <div class="mt-2">
                    ...
                    <textarea class="form-control" name="group_content[]" rows="6" id="groupContent"
                ...
                <div class="row">
                    <div class="col"><button type="submit" class="btn btn-success w-25 mt-3 add-btn">Add Group</button>
                    </div>
