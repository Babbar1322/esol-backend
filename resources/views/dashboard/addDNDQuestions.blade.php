...
@section('content')
    ...
    @if (count($data->test_groups) == 0)
        <div class="card card-one mt-3 shadow">
            <div class="card-body py-3 text-center">
                <img src="https://cdn-icons-png.flaticon.com/512/1380/1380641.png" draggable="false"
                     style="max-width: 15%">
        ...
        <div class="card card-one mt-3 shadow">
            <div class="card-body p-3">
                <div class="mb-3">
                    ...
                    <input type="number" name="question_number" class="form-control" id="question_number"
                           placeholder="Question Number">
                </div>
                <div class="mb-3">
                    <label for="number_of_questions" class="form-label">How many questions? <span
                            title="This will create a group of questions and bring all the answers together."><i
                                class="ri-question-fill h5"></i></span></label>
                    <input type="number" name="number_of_questions" class="form-control" id="number_of_questions"
    ...
    <script>
        function submitData() {
            ...
            let marksInputs = $('[name="marks[]"]');
            let marks = marksInputs.map(function () {
                return this.value;
            }).get();
        ...
        $(document).ready(() => {
            ...
            $('#number_of_questions').blur(function () {
                ...
                const input = function (number) {
                    return (
                        `<div class=mb-3><div class="align-items-start row"><div class="col-1 pe-0"><span class="bg-secondary fs-5 px-2 rounded-2 text-white">${number}</span></div><div class="col"><div class="mb-1"><label class="form-label" for="question">Question</label><input class="form-control" id="question" name="sub_questions[]" placeholder="Question"></div><div id="answer"><div class="mb-3" id="answerElement"><label class="form-label" for="answer">Answers</label><input class="form-control" id="answer" name="answers[]" placeholder="Enter Answer"></div></div><div id="marks"><div class="mb-3" id="marksElement"><label class="form-label" for="marks">Marks</label><input class="form-control" id="marks" name="marks[]" placeholder="Enter Marks" type="number"></div></div></div></div></div>`
                    )
                }
