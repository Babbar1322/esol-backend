...
<div class="d-flex align-items-center justify-content-between mb-4">
    <div>
        <ol class="breadcrumb fs-sm mb-1">
            ...
            <li class="breadcrumb-item active" aria-current="page">Submitted Writing Tests</li>
        </ol>
        <h4 class="main-title mb-0">List of All Writing Tests that are Submitted by Students</h4>
    </div>
</div>
